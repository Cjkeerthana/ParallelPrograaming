...
#ifdef hdf5
    print_hdf5_time_evolution(matrix_new, loc_dimension, dimension, rank, np, res, offset, it);
#else
...
void print_hdf5_time_evolution( double * matrix,  size_t d_loc, size_t dimension, int rank, int npes, size_t rest, size_t offset, size_t it )  
{
